...
namespace Infrastructure.Data
{
    public class StoreContext : DbContext
    {
        ...
        public DbSet<BuyRegister> BuyRegisters { get; set; }
        public DbSet<SaleRegister> SaleRegisters { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Location>()
                        .HasOne(l => l.BuyRegister)                 // Location has one BuyRegister
                        .WithOne(r => r.Location)                   // BuyRegister has one Location
                        .HasForeignKey<BuyRegister>(r => r.LocationId) // FK defined in BuyRegister
                        .OnDelete(DeleteBehavior.Cascade);          // Optional: delete register when location deleted
            
            modelBuilder.Entity<Location>()
                        .HasOne(l => l.SellRegister)
                        .WithOne(r => r.Location)
                        .HasForeignKey<SaleRegister>(r => r.LocationId)
