...
{
    /// <inheritdoc />
    public partial class imagescolum : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Photos",
                columns: new[] { "Id", "FileName", "IsMain", "PictureUrl", "ProductId" },
                values: new object[,]
                {
                    { 1, "Action", true, "/images/product/placeholder.jpg", null },
                    { 2, "Action", false, "/images/product/placeholder.jpg", null },
                    { 3, "Action", false, "/images/product/placeholder.jpg", null },
                    { 4, "Action", false, "/images/product/placeholder.jpg", null },
                    { 5, "Action", false, "/images/product/placeholder.jpg", null },
                    { 6, "Action", false, "/images/product/placeholder.jpg", null }
                });
